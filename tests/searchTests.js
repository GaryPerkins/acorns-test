...
and even those weren't working. The way the select element is used is out of the ordinary, I would
...
module.exports = {
	...
	// 	// init the results page used for this test
	// 	var resultsPage = browser.page.resultsPage();
	...
	'Verify Search Results - Hardcoded' : function(browser) {
		// define what we're looking for in a house
		var maxPrice = 1000000;
		var minBeds = 2;
		var minBaths = 2;
